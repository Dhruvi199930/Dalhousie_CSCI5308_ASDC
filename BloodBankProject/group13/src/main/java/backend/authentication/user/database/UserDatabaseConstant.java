package backend.authentication.user.database;

/**
 * {@code UserDatabaseConstant} stores the information related to the
 * user database.
 *
 */
public final class UserDatabaseConstant {

  // User table.
  public static final String USER_TABLE =
      "user";

  // User unique id column.
  ...
  // User gender column.
  public static final String USER_GENDER_COLUMN =
      "gender";

  // User date of birth column.
