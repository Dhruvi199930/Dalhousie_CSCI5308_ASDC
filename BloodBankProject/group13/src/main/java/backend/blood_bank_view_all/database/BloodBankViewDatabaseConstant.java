...
/**
 * {@code BloodBankViewDatabaseConstant} stores the information related to the
 * blood bank database.
 *
 */
public final class BloodBankViewDatabaseConstant {
  ...
  // Blood bak address country column.
